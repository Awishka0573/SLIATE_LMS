...
<div class="slider-container">
    <div class="slider">
        <img src="Images/Slider/slide1.jpg" class="slide" alt="Slide 1">
        <img src="Images/Slider/slide2.jpg" class="slide" alt="Slide 2">
        <img src="Images/Slider/slide3.jpg" class="slide" alt="Slide 3">
    </div>
...
<div class="crew-section">
    ...
    <div class="crew-container">
        <div class="crew-member">
            <img src="Images/Crew_profile/profile2.JPG" alt="Member 1" class="profile-photo"> <!-- Replace with actual image path -->
            <h3>Awishka Isuru</h3>
            <p>Founder & CEO</p>
        </div>
        <div class="crew-member">
            <img src="Images/Crew_profile/profile1.JPG" alt="Member 2" class="profile-photo"> <!-- Replace with actual image path -->
            <h3>Sandesh Nawarathne</h3>
            <p>Head of Development</p>
        </div>
        <div class="crew-member">
            <img src="Images/Crew_profile/profile2.JPG" alt="Member 3" class="profile-photo"> <!-- Replace with actual image path -->
            <h3>Chavindu Priyasara</h3>
            <p>Marketing Specialist</p>
        </div>
        <div class="crew-member">
            <img src="Images/Crew_profile/profile1.JPG" alt="Member 4" class="profile-photo"> <!-- Replace with actual image path -->
